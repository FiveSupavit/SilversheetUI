...
@section('page.title','Certificate Nurse | Silversheet')
@section('style')
    <!-- Stylesheets -->
                ...
                <div class="examle-wrap">
                    <div class="panel">
                        <div class="panel-heading" id="exampleHeadingDefaultOne" role="tab">
                            <h3 class="panel-title">State License</h3>
                                            ...
                                            <form autocomplete="off">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="text" name="right" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                ...
                <div class="panel btn-direction btn-left mb-0 w-100">
                    <div class="panel-body p-2">
                        <button type="button" class="btn btn-block btn-default btn-sm btn-1 collapsed" data-toggle="collapse" href="#exampleCollapseDefaultOne"
                                aria-expanded="false" aria-controls="exampleCollapseDefaultOne" onclick="ClickExampleCollapse(1)">INPUT LICENSE</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="examle-wrap">
                    <div class="panel">
                        <div class="panel-heading" id="exampleHeadingDefaultTwo" role="tab">
                            <h3 class="panel-title">Add Nursing School</h3>
                            <div class="panel-actions panel-actions-keep">
                                <a href=""><i class="wb-settings btn btn-icon btn-default btn-outline" aria-hidden="true"></i></a>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-6">
                                        <div class="example">
                                            <form autocomplete="off">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="inputBasicFirstName">Nursing School</label>
                                                    <input type="text" class="form-control" id="inputBasicFirstName" name="inputFirstName"
                                                           placeholder="Enter Nursing School" autocomplete="off"/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-control-label" for="inputBasicFirstName">Start year
                                                        <span class="required">*</span>
                                                    </label>
                                                    <input type="text" class="form-control w-50" id="inputBasicFirstName" name="inputFirstName" autocomplete="off"/>
                                                </div>
                ...
                <div class="panel btn-direction btn-left mb-0 w-100">
                    <div class="panel-body p-2">
                        <button type="button" class="btn btn-block btn-default btn-sm btn-3 collapsed" data-toggle="collapse" href="#exampleCollapseDefaultThree"
                                aria-expanded="false" aria-controls="exampleCollapseDefaultThree" onclick="ClickExampleCollapse(3)">UPLOAD COPY</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="panel btn-direction btn-left mb-0 w-100">
                    <div class="panel-body p-2">
                        <button type="button" class="btn btn-block btn-default btn-sm btn-4 collapsed" data-toggle="collapse" href="#exampleCollapseDefaultFour"
                                aria-expanded="false" aria-controls="exampleCollapseDefaultFour" onclick="ClickExampleCollapse(4)">UPLOAD COPY</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="panel btn-direction btn-left mb-0 w-100">
                    <div class="panel-body p-2">
                        <button type="button" class="btn btn-block btn-default btn-sm btn-5 collapsed" data-toggle="collapse" href="#exampleCollapseDefaultFive"
                                aria-expanded="false" aria-controls="exampleCollapseDefaultFive" onclick="ClickExampleCollapse(5)">UPLOAD COPY</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="panel btn-direction btn-left mb-0 w-100">
                    <div class="panel-body p-2">
                        <button type="button" class="btn btn-block btn-default btn-sm btn-6 collapsed" data-toggle="collapse" href="#exampleCollapseDefaultSix"
                                aria-expanded="false" aria-controls="exampleCollapseDefaultSix" onclick="ClickExampleCollapse(6)">INPUT</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="panel btn-direction btn-left mb-0 w-100">
                    <div class="panel-body p-2">
                        <button type="button" class="btn btn-block btn-default btn-sm btn-7 collapsed" data-toggle="collapse" href="#exampleCollapseDefaultSeven"
                                aria-expanded="false" aria-controls="exampleCollapseDefaultSeven" onclick="ClickExampleCollapse(7)">INPUT</button>
                    </div>
                </div>
            </div>
        </div>
